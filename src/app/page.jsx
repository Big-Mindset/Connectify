     ...
     duration-300  before:transition-all
      ...
      className={`absolute right-4 top-0 z-50  bg-blue-500/60 `}></motion.div>
        ...
        {width > 768 ?
          ...
          <div className={`basis-full md:basis-1/3 relative from-800/20 bg-[#0D1520]  p-3`}>
             <motion.div
         initial={{height : 0}}
         animate={{height : mounted ? "100%" : 0}}
         transition={{duration : 1 , ease : "easeInOut" ,delay : 0.2}}
        className={`absolute right-0 top-0 z-50  w-[0.3px]  h-[1px]  ${showBlur && "dark:shadow-[1px_0_5px_2px_#37209e]"}  bg-[#205D9E]`}></motion.div>
        ...
        {(Selected || selectedGroup) ? (
          ...
          <div className={`mt-30 w-full flex gap-5 flex-col ${Completed ? "opacity-100 duration-1000 delay-1000" : "opacity-0"}`}>
            ...
            <div className='flex justify-center mt-28'>
              <Image src={properLogo} height={100} width={100} alt="Connectify-Logo" />
            </div>
